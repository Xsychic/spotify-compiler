# SPOTIFY TOP 40 PLAYLIST COMPILER
...
filename = './latest_playlist_40.csv' #last top 40 chart in csv
playlist_id = '4SqQ8uV5snjbvZNfXLeuuT' #top 40 playlist id
client_id = '1b7c94f5677445369a1d0201f2d306d6'
client_secret = '31e9685d49f14754a6f979c534ddea38'
url = 'https://www.officialcharts.com/charts/uk-top-40-singles-chart/' #top 40 url
...
def get_song_ids(songs):
    #get uri for each song in top 40
...
def send_tracks_to_playlist(uris):
    ...
    spotify.user_playlist_change_details(username, playlist_id, name='{} UK Top 40'.format(date))

    print("\nPlaylist of the UK top 40 from {} compiled".format(date))
